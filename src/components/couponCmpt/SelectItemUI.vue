  ...
  <div class="popup-mask" v-on:click.self="showUIFn(false)">
    <div class="popup-content">
      ...
      <div class="service-content" v-show="itemTypeRef == 1">
        <CheckboxServiceUI
          :selData="formInputRef.serviceItem"
          :getDataFn="getCServiceFn"
...
function getCServiceFn(data: any) {
  console.log(data, "獲取");
  formInputRef.value.serviceItem = data;
}
function getCGoodsFn(data: any) {
  console.log(data, "獲取");
  formInputRef.value.goods = data;
}
</script>
