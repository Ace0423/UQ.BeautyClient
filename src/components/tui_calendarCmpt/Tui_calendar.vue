<template>
  <div>
      ...
      <a href="https://github.com/nhnent/tui.calendar">
        <img
          ...
          srcset="
            ...
            ../src/assets/images/img-bi@3x.png 3x
          "
        />
      </a>
    </div>
    ...
    <div id="right">
      <div id="menu" class="menu_cal">
        <select id="myList" style="height: 30px">
          <option>---Choose tutorial---</option>
          <option>toggle-daily</option>
          <option>toggle-weekly</option>
          <option>toggle-monthly</option>
        </select>
        <!-- <span class="dropdown">
          <button
...
export default {
  ...
  mounted: function () {
    ...
    function setEventListener() {
      ...
      // );
      document.getElementById("menu-navi_today").addEventListener(
        "click",
        function () {
          onClickNavi("move-today");
        },
        true
      );
      document.getElementById("menu-navi_prev").addEventListener(
        "click",
        function () {
          onClickNavi("move-prev");
        },
        true
      );
      document.getElementById("menu-navi_next").addEventListener(
        "click",
        function () {
          onClickNavi("move-next");
        },
        true
      );
      ...
      mylist.addEventListener(
        "change",
        function () {
          onClickMenu(mylist.options[mylist.selectedIndex].text);
        },
        true
      );

      // document
      //   .getElementsByClassName('dropdown-menu a[role="menuitem"]')
      //   .addEventListener(
      //     "click",
      //     function () {
      ...
      // document.getElementById("dropdownMenu-calendarType").addEventListener(
      //   "click",
      //   function () {
      //     console.log(
      //       document.getElementById("dropdownMenu-calendarType"),
      //       "Parent Capturing"
      //     );
      //     test();
      //   },
      ...
      document
        .getElementById("lnb-calendars")
        .addEventListener("change", onChangeCalendars);

      if (document.getElementById("btn-save-schedule"))
        document.getElementById("btn-save-schedule").onClick = onNewSchedule;

      document.getElementById("btn-new-schedule").onClick = createNewSchedule;
      if (document.getElementById("dropdownMenu-calendars-list"))
        document.getElementById("dropdownMenu-calendars-list").onClick =
          onChangeNewScheduleCalendar;
